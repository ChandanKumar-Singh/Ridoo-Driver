...
//base url
String url =
    'https://ridoo.in/'; // add '/' at the end of the url as 'https:www.yourwebsite.com/'
String mapkey = 'AIzaSyBycdBnMr1J_Irv08M_Q6k9BDEBzqIXy5Y';
String mapStyle = '';
...
geolocs.LocationSettings locationSettings = (platform == TargetPlatform.android)
    ? geolocs.AndroidSettings(
        ...
        foregroundNotificationConfig:
          ...
          notificationText:
              "Ridoo Driver will continue to receive your location in background",
